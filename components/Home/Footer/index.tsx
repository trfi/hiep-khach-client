export const Footer = () => {
  return (
    <footer className="flex justify-between pt-10 px-28">
      <img width={340} src="/images/footer-left.png" alt="footer left" />
      <div className="flex flex-col justify-end pb-10 items-center">
        ...
        <div className="flex gap-4">
          <a href="https://twitter.com/hiepkhachtranhhung" target="_blank">
            <img width="60" src="/images/twitter.svg" alt="Twitter" />
          </a>
          <a href="https://t.me/hiepkhachtranhhung" target="_blank">
            <img width="60" src="/images/telegram.svg" alt="Telegram" />
          </a>
          <a href="https://www.facebook.com/hiepkhachtranhhung" target="_blank">
